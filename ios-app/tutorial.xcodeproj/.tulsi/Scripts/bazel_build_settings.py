...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_doug/293c64487d5a708fb2fcf2bc7d9565c1/execroot/__main__',
    'ios_x86_64',
    {
        'watchos_armv7k': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/doug/Library/Application Support/Tulsi/0.20191009.88/Bazel',
